      ...
      {mode === 'plain_text' ? (
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className="w-full rounded-control border border-border bg-surface-card px-3 py-2 text-sm text-ink transition-colors placeholder:text-ink-faint hover:border-border-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40"
          />
        </div>
      ) : null}
      {rowCount > 0 ? (
